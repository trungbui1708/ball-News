							...
							<div class="header-top-left">                            
								<ul>
									...
									<li><img src="<?php echo e(asset('index/images/logo/vn.png')); ?>" alt="Logo">
										...
										<ul>
											<li><img src="<?php echo e(asset('index/images/logoe.png')); ?>" alt="Logo"><a href="#">English</a></li>
										</ul>
									</li>
								</ul>
							</div>
							...
							<div class="social-media-area">
								<nav>
									<ul>
                                        ...
                                        <li>
                                            <a>
                                                <span class=""><?php echo e($nguoidung->first_name); ?></span>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-2 col-sm-12 col-xs-12 logo">
                            <a href="<?php echo e(url('home')); ?>"><img src="<?php echo e(asset('index/images/logo.png')); ?>" alt="logo"></a>
                        </div>
                                    ...
                                    <ul class="nav-menu">
                                        ...
                                        <li class="menu-item-has-children">
                                            ...
                                            <!-- <ul class="sub-menu">
                                                ...
                                                <li><a href="ranking"><?php echo $key->name; ?></a></li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </ul>      -->    
                                        </li>
